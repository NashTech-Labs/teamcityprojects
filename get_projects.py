...
def get_projectinfo(url="https://teamcity.dns.com",suburl="/app/rest/projects/id:_Root"):
    print("\n-----------API_Called------------\n")
    print(url+suburl)
...
if __name__== '__main__':
    ...
    teamcity_url = os.getenv('server-url',"https://teamcity.dns.com")
    ...
    projectdataframe = pd.DataFrame(projects_details)
    projectdataframe.to_excel("Project.xlsx")